...
| 命令 | 代码 | 功能 | 数据格式 |
|------|------|------|---------|
| MOVE_SINGLE | 0x01 | 单轴控制 | [舵机ID][角度高][角度低][时间高][时间低] |
| MOVE_ALL | 0x03 | 8轴同步 | [角度1高][角度1低]...[角度8高][角度8低][时间高][时间低] |
| GET_SINGLE | 0x10 | 查询单轴 | [舵机ID] |
| GET_ALL | 0x11 | 查询全轴 | - |
| ENABLE | 0x20 | 使能舵机 | [舵机ID] (0xFF=全部) |
| DISABLE | 0x21 | 禁用舵机 | [舵机ID] (0xFF=全部) |
